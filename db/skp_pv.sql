...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 02 Des 2025 pada 14.18
...
INSERT INTO `dosen` (`id`, `user_id`, `nip`, `nama`, `prodi`, `email`, `telp`) VALUES
(1, 1, '123', 'azzam', 'TI', 'azzam@gmail.com', '08241638351261'),
(3, 3, 'nashwan', 'Kanisa Nashwan', 'TMJ', 'kanisa@gmail.com', '081342617888');

-- --------------------------------------------------------

--
-- Struktur dari tabel `ms_pertanyaan`
--
...
--
-- Dumping data untuk tabel `ms_pertanyaan`
--
...
INSERT INTO `tr_penilaian` (`id`, `id_pertanyaan`, `username_penilai`, `target_dosen_nip`, `periode`, `nilai_skor`, `catatan`, `bukti_pendukung`) VALUES
(1, 2, 'nashwan', 'nashwan', '2024/2025 Ganjil', '5', NULL, NULL),
(2, 7, 'nashwan', 'nashwan', '2024/2025 Ganjil', '9', NULL, NULL),
(3, 8, 'nashwan', 'nashwan', '2024/2025 Ganjil', '7', NULL, NULL),
(4, 9, 'nashwan', 'nashwan', '2024/2025 Ganjil', '8', NULL, NULL),
(5, 16, 'nashwan', 'nashwan', '2024/2025 Ganjil', '10', NULL, NULL),
(6, 17, 'nashwan', 'nashwan', '2024/2025 Ganjil', '8', NULL, NULL),
(7, 18, 'nashwan', 'nashwan', '2024/2025 Ganjil', '9', NULL, NULL),
(8, 2, 'nashwan', '123', '2024/2025 Ganjil', '6', NULL, NULL),
(9, 7, 'nashwan', '123', '2024/2025 Ganjil', '8', NULL, NULL),
(10, 8, 'nashwan', '123', '2024/2025 Ganjil', '8', NULL, NULL),
(11, 9, 'nashwan', '123', '2024/2025 Ganjil', '9', NULL, NULL),
(12, 16, 'nashwan', '123', '2024/2025 Ganjil', '4', NULL, NULL),
(13, 17, 'nashwan', '123', '2024/2025 Ganjil', '10', NULL, NULL),
(14, 18, 'nashwan', '123', '2024/2025 Ganjil', '10', NULL, NULL);

-- --------------------------------------------------------

--
-- Struktur dari tabel `tr_status_penilaian`
--
...
--
-- Dumping data untuk tabel `tr_status_penilaian`
--

INSERT INTO `tr_status_penilaian` (`id`, `nip`, `periode`, `status_dosen`, `status_admin`, `status_kps`, `nilai_akhir`, `predikat`) VALUES
(1, 'nashwan', '2024/2025 Ganjil', 1, 0, 0, 0, '-'),
(2, '123', '2024/2025 Ganjil', 1, 0, 0, 0, '-');
...
--
-- Indeks untuk tabel `ms_pertanyaan`
--
...
--
-- Indeks untuk tabel `tr_status_penilaian`
--
...
--
-- AUTO_INCREMENT untuk tabel `ms_pertanyaan`
--
ALTER TABLE `ms_pertanyaan`
...
--
-- AUTO_INCREMENT untuk tabel `tr_status_penilaian`
--
ALTER TABLE `tr_status_penilaian`
